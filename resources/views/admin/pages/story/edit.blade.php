                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" rows="5"
                                        class="form-control @error('description') is-invalid @enderror" required placeholder="Nhập mô tả (văn bản thuần)...">{{ old('description', description_for_edit($story->description)) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
