                ...
                <div class="card-header pb-0">
                    <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-2">
                            ...
                            <a href="{{ route('admin.paypal-deposits.index') }}" class="btn bg-gradient-primary btn-sm">
                                <i class="fab fa-paypal me-2"></i><span class="d-none d-md-inline">Quản lý PayPal Deposits</span><span class="d-md-none">PayPal</span>
                            </a>
                        </div>
                    </div>
