                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ngày yêu cầu</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Số xu</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Phí</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Thực nhận</th>
                                    ...
                                    @foreach($withdrawalRequests as $request)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-xs text-secondary mb-0">{{ $request->created_at->format('H:i:s') }}</p>
                                            </td>
                                            <td>
