                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                           id="code" name="code" value="{{ old('code', $bank->code) }}" required>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="logo">Chọn file mới</label>
                                        @error('logo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2 {{ $bank->logo ? '' : 'd-none' }}" id="logo-preview-container">
                                        <img src="{{ $bank->logo ? Storage::url($bank->logo) : '' }}" alt="Logo Preview" id="logo-preview" class="img-thumbnail" style="max-height: 100px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="qr_code">Chọn file mới</label>
                                        @error('qr_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mt-2 {{ $bank->qr_code ? '' : 'd-none' }}" id="qr-preview-container">
                                        <img src="{{ $bank->qr_code ? Storage::url($bank->qr_code) : '' }}" alt="QR Code Preview" id="qr-preview" class="img-thumbnail" style="max-height: 100px;">
                                    </div>
                                </div>
                            </div>
                        </div>
