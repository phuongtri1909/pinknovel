                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted">
                                Ngày gửi: {{ $story->submitted_at ? \Carbon\Carbon::parse($story->submitted_at)->format('H:i:s d/m/Y') : 'N/A' }}
                                @if ($story->reviewed_at)
                                <br>Ngày xét duyệt: {{ $story->reviewed_at ? \Carbon\Carbon::parse($story->reviewed_at)->format('H:i:s d/m/Y') : 'N/A' }}
                                @endif
                            </p>
                        </div>
                    </div>
                            ...
                            @if ($story->status == 'pending')
                                ...
                                <div class="actions-container">
                                    ...
                                    <div class="row">
                                        <!-- Approve form -->
                                        <div class="col-md-6">
                                            <form action="{{ route('admin.story-reviews.approve', $story) }}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="approve_note" class="form-label">Ghi chú khi duyệt (không bắt buộc)</label>
                                                    <textarea class="form-control" id="approve_note" name="admin_note" rows="3" placeholder="Ghi chú khi duyệt truyện..."></textarea>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <form action="{{ route('admin.story-reviews.reject', $story) }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="reject_note" name="admin_note" rows="3" required placeholder="Lý do từ chối truyện..."></textarea>
                                                </div>
