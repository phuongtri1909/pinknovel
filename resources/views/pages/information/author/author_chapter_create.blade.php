            ...
            <div class="tab-content" id="uploadTypeTabContent">
                ...
                <div class="tab-pane fade" id="batch-upload" role="tabpanel" aria-labelledby="batch-tab">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mt-3 mb-0">
                            <li>Hệ thống hỗ trợ cả hai định dạng: <code>[Chương X] : Tiêu đề</code> (mới) và <code>Chương X:
                                    Tiêu đề</code> (cũ)</li>
                    ...
                    <form action="{{ route('user.author.stories.chapters.store', $story->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-muted">Nếu để trống, hệ thống sẽ tự tìm kiếm các định dạng phổ biến
                                như "Chương", "Chapter", "Chap".</div>
                        ...
                        <div class="chapter-options">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Hình thức chương <span class="text-danger">*</span></label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_free" id="batch_is_free_yes"
                                        value="1" {{ old('is_free', '1') == '1' ? 'checked' : '' }}
                                        onchange="toggleBatchPricingOptions()">
                                    <label class="form-check-label" for="batch_is_free_yes">
                                        <i class="fas fa-unlock text-success me-1"></i> Miễn phí
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_free" id="batch_is_free_no"
                                        value="0" {{ old('is_free') == '0' ? 'checked' : '' }}
                                        onchange="toggleBatchPricingOptions()">
                            ...
                            <div class="pricing-options" id="batchPricingOptions">
                                <div class="mb-3">
                                    <label for="batch_price" class="form-label">Giá chương (Coin) <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                            ...
                            <div class="password-options" id="batchPasswordOptions">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="has_password"
                                            id="batch_has_password_yes" value="1"
                                            {{ old('has_password') == '1' ? 'checked' : '' }}
                                            onchange="toggleBatchPasswordField()">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="has_password"
                                            id="batch_has_password_no" value="0"
                                            {{ old('has_password', '0') == '0' ? 'checked' : '' }}
                                            onchange="toggleBatchPasswordField()">
                                ...
                                <div class="mb-3" id="batchPasswordField"
                                    style="{{ old('has_password') == '1' ? '' : 'display: none;' }}">
                                    <label for="batch_password" class="form-label">Mật khẩu chương <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="password"
                                        ...
                                        <span class="input-group-text toggle-password"
                                            onclick="toggleBatchPasswordVisibility()">
                                            <i class="fas fa-eye"></i>
                                        </span>
                                    </div>
                            ...
                            <div class="publish-options">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="batch_status_draft" value="draft"
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="batch_status_published" value="published"
                                            {{ old('status') == 'published' ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <label class="form-label d-flex align-items-center">
                                        <input type="checkbox" class="form-check-input me-2" id="batchEnableSchedule"
                                            onchange="toggleBatchScheduleField()"
                                            {{ old('scheduled_publish_at') ? 'checked' : '' }}>
                                        Hẹn giờ xuất bản
                                    </label>
                                    <div id="batchScheduleField"
                                        style="{{ old('scheduled_publish_at') ? '' : 'display: none;' }}">
                                        <input type="datetime-local"
                                            class="form-control @error('scheduled_publish_at') is-invalid @enderror"
                                            id="batch_scheduled_publish_at" name="scheduled_publish_at"
                                            value="{{ old('scheduled_publish_at') }}">
...
@push('info_scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($('#batch_has_password_yes').is(':checked')) {
            ...
            @if (session('error') && old('upload_type') == 'multiple')
                $(document).ready(function() {
                    $('#batch-tab').tab('show');
                });
            @endif
        ...
        // Thêm validation cho form tạo nhiều chương
        $('#batchChapterForm').on('submit', function(e) {
            if ($('#batch_has_password_yes').is(':checked')) {
                if ($('#batch_password').val() === '') {
                    e.preventDefault();
                    alert('Vui lòng nhập mật khẩu cho các chương.');
                    $('#batch_password').focus();
                }
            }
        });
    </script>
