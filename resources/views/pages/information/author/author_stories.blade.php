        ...
        <form action="{{ route('user.author.stories') }}" method="GET" class="row g-3">
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="search" placeholder="Tìm kiếm truyện..." value="{{ request('search') }}">
                </div>
            </div>
            <div class="col-md-3">
            ...
            <table class="table table-hover table-stories">
                <thead>
                    <tr>
                        ...
                        <th scope="col" width="180">Hành động</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr class="story-row">
                            ...
                            <td>
                                ...
                                <div class="text-muted small">
                                    <span class="me-2"><i class="fas fa-book me-1"></i>{{ $story->chapters->count() }} chương</span>
                                    <span><i class="fas fa-calendar-alt me-1"></i>{{ $story->created_at->format('d/m/Y') }}</span>
                                </div>
                                <div class="small mt-1">
                                    ...
                                    @if($story->categories->count() > 3)
                                        <span class="badge bg-light text-dark">+{{ $story->categories->count() - 3 }}</span>
                                    @endif
                                </div>
                            </td>
                            <td>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-confirm">
                                <div class="modal-content">
                                    <div class="modal-header flex-column border-0 pb-0">
                                        ...
                                        <h4 class="modal-title w-100 text-center" id="deleteModalLabel{{ $story->id }}">
                                            Xác nhận xóa
                                        </h4>
                                    ...
                                    <div class="modal-body text-center py-4">
                                        ...
                                        <p class="text-danger small">Tất cả các chương sẽ bị xóa và không thể khôi phục.</p>
                                    </div>
                                    <div class="modal-footer justify-content-center border-0 pt-0">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                        <form action="{{ route('user.author.stories.destroy', $story->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
