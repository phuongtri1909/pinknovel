            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                        id="description2" name="description" rows="6">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('story_type') is-invalid @enderror" 
                        ...
                        <option value="translated" {{ old('story_type') == 'translated' ? 'selected' : '' }}>Dịch/Edit</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('cover') is-invalid @enderror" 
                        id="cover" name="cover" accept="image/*" required>
                    @error('cover')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
