<div class="d-flex align-items-start mb-2 text-gray-600">
    ...
    <div class="flex-grow-1">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="fs-8"><i class="fa-solid fa-bookmark fs-8 text-danger"></i> {{ number_format($story->bookmarks_count) }}</div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <p class="badge bg-1 text-white small rounded-pill d-flex align-items-center">{{ $story->chapters_count ?? ($story->chapters ? $story->chapters->count() : 0) }} chương</p>
            </div>
        </div>
    </div>
</div>
